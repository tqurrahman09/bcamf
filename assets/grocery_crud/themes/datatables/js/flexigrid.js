$(function(){
	...
	$('.ajax_list').on('click','.delete-row', function(){
        ...
        $('.ajax_list').on('click','.ats_approve', function(){
            var approve_url = $(this).attr('href');

            var this_container = $(this).closest('.flexigrid');

            alertify.confirm( 'Are you sure want to Approve?' , function(){
                $.ajax({
                    url: approve_url,
                    dataType: 'json',
                    success: function(data)
        ...
        $('.ajax_list').on('click','.ats_reject', function(){
            
            var reject_url = $(this).attr('href');

            var this_container = $(this).closest('.flexigrid');

            alertify.prompt( 'Reject Reason' , '', function(evt, value){
                $.ajax({
                    url: reject_url,
                    type: "POST",
                    data: {reason:value},
