        ...
        <table class="table table-bordered table-hover" id="flex1">
            <thead>
                <tr class='hDiv'>
                    ...
                    <th class="text-center" style="vertical-align: middle;"><?php echo strtoupper($column->display_as) ?></th>
                    <?php } ?>
                ...
                foreach ($list as $num_row => $row) { ?>        
                    <tr>
                        ...
                        <td class="td-action" style="white-space: nowrap; width: auto;">
                            ...
                            <?php if (!$unset_delete) { ?>
                                <li>
                                    <a href='<?php echo $row->delete_url ?>' title='<?php echo $this->l('list_delete') ?> <?php echo $subject ?>' class="delete-row" ><i class='fa fa-trash-o fa-trash'></i></a>
                                </li>
                            <?php } ?>
                                </ul>
                            </td>
