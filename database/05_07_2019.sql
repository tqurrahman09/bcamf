...
insert  into `monthly_expense`(`id`,`user_id`,`month`,`sum`,`post`,`import`,`ax_journal_num`,`create_date`,`create_by`,`update_date`,`update_by`) values 
(1,1,'2019-07-02',200000.00,0,1,'1000','2019-07-02 15:31:15',NULL,'2019-07-02 15:31:15',NULL);
...
CREATE TABLE `monthly_expense_detail` (
  ...
  CONSTRAINT `monthly_expense_detail_ibfk_2` FOREIGN KEY (`me_code`) REFERENCES `master_me_type` (`me_code`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
...
(1,'ME-C',1,'2019-07-02','Desc test',0,100,30.00,300000.00,'Remark test');
