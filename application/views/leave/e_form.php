<div class="m-grid__item m-grid__item--fluid m-wrapper">
  ...
  <div class="m-content">
    ...
    <div class="m-portlet">
      ...
      <!--begin::Form-->
      <?php echo form_open('leave/editsubmit', array('class' => 'm-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed', 'id' => 'a-form')); ?>
      <div class="m-portlet__body">
        ...
        <?php
          $temp = $leave->row();
        ?>
        <input type="hidden" name="id" value="<?php echo $this->input->get('q'); ?>">
        <div class="form-group m-form__group row">
          <div class="col-lg-4 m-form__group-sub">
            <label class="form-control-label">Date*:</label>
            <input type="text" class="form-control m-input" name="date" id="date" readonly="" value="<?php echo $leave_detail->row()->dates; ?>">
            <span class="m-form__help">Please enter your leave dates</span>
          </div>
          <div class="col-lg-3 m-form__group-sub">
            <label class="form-control-label">Head:</label>
            <input type="text" class="form-control m-input" name="head" id="head" value="<?php echo $temp->head; ?>" disabled="true">
        ...
        <div class="form-group m-form__group row">
          <div class="col-lg-4 m-form__group-sub">
            ...
            <div class="m-input-icon m-input-icon--right">
              <textarea class="form-control m-input" name="purpose" id="purpose" rows="3"><?php echo $temp->purpose; ?></textarea>
            </div>
          ...
          <div class="col-lg-4 m-form__group-sub">
            ...
            <div class="m-input-icon m-input-icon--right">
              <textarea class="form-control m-input" name="job" id="job" rows="3"><?php echo $temp->job; ?></textarea>
            </div>
        ...
        <div class="form-group m-form__group row">
          <div class="col-lg-4 m-form__group-sub">
            ...
            <input type="text" class="form-control m-input" name="job_delegation" id="job-delegation" value="<?php echo $temp->job_delegation; ?>">
          ...
          <div class="col-lg-4 m-form__group-sub">
            ...
            <select class="form-control m-input" name="type" id="type">
              ...
              <option value="1" <?php if($temp->type == 1) echo 'selected' ?>>Leave</option>
              <option value="1" <?php if($temp->type == 2) echo 'selected' ?>>Change Day</option>
            </select>
