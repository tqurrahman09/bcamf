<!-- begin::Modal-->
<div class="modal fade" id="e-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <div class="form-group m-form__group row">
            ...
            <div class="col-lg-4 col-md-9 col-sm-12">
              <div class="input-group">
                <input type="text" name="e_group_name" class="form-control m-input" id="e-name-group" placeholder="Nama Group" maxlength="30" readonly="">
              ...
              <span class="m-form__help">Group name cannot be changed</span>
            </div>
          </div>
          <div class="form-group m-form__group row">
            ...
            <div class="col-lg-4 col-md-9 col-sm-12">
              <div class="input-group">
                <select name="e_modules[]" id="e-module_" class="form-control m-input" multiple="multiple">
          ...
          <div class="form-group m-form__group row">
            <div class="offset-lg-2 col-lg-4 col-md-9 col-sm-12">
              <label class="m-checkbox">
                <input type="checkbox" name="e_is_accounting" id="e-is-accounting" value="1"> Accounting?
                <span></span>
              </label>
            </div>
          </div>
