          ...
          <div class="m-form__section m-form__section--first">
            ...
            <div class="form-group m-form__group row">
              ...
              <div class="col-lg-3 m-form__group-sub">
                ...
                <input type="text" class="form-control m-input unpaid_amt" name="unpaid_amt" id="unpaid_amt" placeholder="Unpaid Amount" value="<?php echo $pc->unpaid_amt; ?>"  style="text-align: right;" >
                <span class="m-form__help">Please enter Unpaid amount</span>
              </div>
              <!-- end by ronix -->
              <div class="col-lg-3 m-form__group-sub">
                <label class="col-form-label">Pending Document:</label>
                <input type="text" class="form-control m-input pending_amt" name="pending_amt" id="pending_amt" placeholder="Pending Document" value="<?php echo $pc->pending_amt; ?>" style="text-align: right;">
                <span class="m-form__help">Please enter Pending Document amount</span>
              </div>

              <div class="col-lg-3 m-form__group-sub">
                <label class="col-form-label">Prepared By</label>
                <input type="text" class="form-control m-input prepared_by" name="prepared_by" id="prepared_by" placeholder="Prepared By" value="<?php echo $pc->prepared_by; ?>" style="text-align: right;">
            ...
            <table class="table table-bordered" id="a-repeater">
              ...
              <tbody id="m_repeater_1" data-repeater-list="details">
                <tr data-repeater-item>
                  ...
                  <td>
                    <div class="form-group m-form__group" style="padding: 0px 0px 0px 0px;">
                      <input type="text" class="form-control m-input amount" name="ammount" required="true" placeholder="Enter amount" style="text-align: right;">
                    </div>
                  </td>
                  <!-- end atan -->
                  <td>
