      ...
      <div class="m-portlet__body">
        <?php if ($file->num_rows() == 0) { ?>
          <div class="m-alert m-alert--outline alert alert-info alert-dismissible fade show" role="alert">
            ...
            <strong>No attacment!</strong> Please upload attachment in image format.
          </div>
        <?php } else { ?>
          <div class="row">
            <?php foreach ($file->result() as $i => $value) { ?>
              <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                ...
                <div class="btn-group m-btn-group m-btn-group--pill" role="group" aria-label="..." style="display: flex; flex: 1">
                  ...
                  <a type="button" class="m-btn btn btn-danger btn-sm m-btn--icon" href="<?php echo site_url('petty-chash/attachment-delete?q='.$this->encrypt->encode($value->id).'&r='.$this->input->get('q')); ?>" style="flex: 1">
                    <span>
                      <i class="flaticon-attachment"></i>
...
<div class="modal fade" id="modal-add">
  <div class="modal-dialog">
    <div class="modal-content">
      <form role="form" action="<?php echo site_url('petty-chash/attachment-submit') ?>" method="post" id="form-add" enctype="multipart/form-data">
