...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Malindo | <?php echo $title; ?></title>
		...
		<!-- For Grocery CRUD -->
		<!-- Grocery bugs -->
		<link rel="stylesheet" href="<?php echo base_url('assets/grocery_crud/css/custom/a-design.css'); ?>">
		<!--Alertify-->
		<link rel="stylesheet" href="<?php echo base_url('assets/grocery_crud/css/alertify/alertify.min.css'); ?>">
		<link rel="stylesheet" href="<?php echo base_url('assets/grocery_crud/css/alertify/default.min.css'); ?>">
		<!--end::Base Styles -->
