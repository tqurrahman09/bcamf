<div class="m-grid__item m-grid__item--fluid m-wrapper">
  ...
  <div class="m-content">
    ...
    <?php } ?>
    <!--begin::Portlet-->
    <?php echo form_open(site_url('budget/edit-submit'), array('id' => 'e-form')); ?>
            ...
            <input type="hidden" name="id" value="<?php echo str_replace(" ", "+", $this->input->get('q')); ?>">
              <div class="col-md-3 m-form__group-sub">
                ...
                <select class="form-control m-input selectpickers" name="user_id" id="user_id" data-live-search="true" required="true">
                  ...
                  <option value="<?php echo $value->user_id ?>"<?php if($value->user_id == $budget->user_id) echo "selected"; ?> ><?php echo $value->worker_code.' - '.$value->username; ?></option>
                    <?php } ?>
                </select>
              </div>
              <div class="col-md-3 m-form__group-sub">
                <label class="col-form-label">Budget BBM</label>
                <input type="text" style="text-align: right;" class="form-control m-input budget_bbm" name="budget_bbm" id="budget_bbm" placeholder="Budget BBM" value="<?php echo number_format($budget->budget_bbm,0,",",",") ?>">
              </div>
              <div class="col-md-3 m-form__group-sub">
                <label class="col-form-label">Budget Pulsa</label>
                <input type="text" style="text-align: right;" class="form-control m-input budget_pulsa" name="budget_pulsa" id="budget_pulsa" placeholder="Budget Pulsa" value="<?php echo number_format($budget->budget_pulsa,0,",",",") ?>">
              </div>
              <div class="col-md-3 m-form__group-sub">
                <label class="col-form-label">Budget Hotel</label>
                <input type="text" style="text-align: right;" class="form-control m-input budget_hotel" name="budget_hotel" id="budget_hotel" placeholder="Budget Hotel" value="<?php echo number_format($budget->budget_hotel,0,",",",") ?>">
              </div>
            </div>
          </div>
        </div>
