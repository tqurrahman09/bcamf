...
class Area extends Master {
    ...
    public function index(){
        ...
        $crud->set_table('master_area');
        $crud->order_by('id');
        $crud->unique_fields(array('area_name'));
        $crud->required_fields('area_name');
        $crud->add_fields('area_name', 'alias', 'insert_by');
        $crud->edit_fields('area_name', 'alias', 'modify_by');
