...
public function index(){
    ...
    $crud->order_by('id');
    $crud->unique_fields(array('department_id'));
    $crud->required_fields('department_id', 'name');
    $crud->add_fields('department_id', 'name', 'insert_by');
    $crud->edit_fields('name', 'modify_date', 'modify_by');
